...
import { useSelector } from "react-redux";
 ...
 function Navbar() {
  ...
  return (
    <>
{selectedConversation && ( <div className="h-14 flex items-center justify-between px-5 border-b border-white/6 bg-[#0d0f14]">
      ...
      <span className="text-[10px] font-medium text-slate-600 bg-white/4 border border-white/6 px-2 py-0.5 rounded-full">
